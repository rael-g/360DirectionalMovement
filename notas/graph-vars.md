# Variáveis do grafo de animação do Starfield 1.16.244

Extraídas de Starfield.exe.original.exe: as strings ocupam um bloco contíguo
entre as linhas 975010 e 975300 do dump de strings. Não é chute — é a tabela.
